...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function processExcelData(rawData) {
        ...
        rawData.forEach((row, index) => {
            ...
            let orderNumber = `UNK-${index}`, trackingNumber = null, courierPhone = null, bookImageUrl = null, productCode = null, productName = "Unknown", quantity = 1, price = 0, shipping = 0, buyer = "Unknown", address = null, province = "Unknown", status = "รอดำเนินการ", note = null;
            if (platform === 'Lazada') {
