...
const ALLOWED_GLASS_COLORS = ['ใส', 'เขียวตัดแสง', 'ชา', 'ฝ้า'];
    ...
    async function fetchSkuData() {
        ...
        try {
            ...
            if (data) {
                ...
                if (glassEl && glassName) glassEl.value = normalizeGlassColor(glassName) || '';
                ...
                if (screenEl && data.net_id != null) {
                    ...
                    screenEl.value = normalizeScreenType(data.net_id === 1 ? 'ไม่มีมุ้ง' : 'มีมุ้ง') || '';
                }
